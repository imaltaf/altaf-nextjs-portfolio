...
export function PostmanIcon(props: ComponentProps<'svg'>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
    ...
    >
      ...
      <path d="M12.033 0C5.4 0 0 5.4 0 12.033c0 6.633 5.4 12.033 12.033 12.033 6.633 0 12.033-5.4 12.033-12.033C24.066 5.4 18.666 0 12.033 0zm0 1.33a10.713 10.713 0 0 1 10.703 10.703c0 3.627-1.858 6.843-4.68 8.732a16.482 16.482 0 0 0-.782-2.343l-.221-.566-3.65-.94-.42 1.628 2.446.63a15.455 15.455 0 0 1-1.13 1.563 5.94 5.94 0 0 0-.722.998c-.04-.22-.104-.47-.19-.752-1.092-3.658-4.755-4.622-6.942-4.935-1.128-.172-2.276-.229-3.352-.162-.268-.694-.496-1.238-.61-1.533l-.02-.06-.57-1.555-.21-.573.597-.105c1.305-.23 4.55.014 7.224 1.402 1.507.8 2.904 1.96 3.724 3.215.436.66.728 1.258.914 1.713.12.295.204.556.264.76.023-.04.053-.08.073-.13a3.547 3.547 0 0 0 .045-.102c.343-.846.183-2.11-.932-3.61-1.243-1.696-3.27-3.06-5.633-3.75-2.317-.676-5.008-.682-7.044-.392.332.894.825 2.204 1.086 2.91l.019.05c.1.273.192.517.274.735.248.662.411 1.086.503 1.327.406 1.073 1.426 2.23 4.695 2.46 1.73.124 3.16-.62 4.487-1.814l.94 2.486-.008.005c.09.263.145.473.186.652.147.65.19 1.17.166 1.495a10.713 10.713 0 0 1-8.61 4.41A10.713 10.713 0 0 1 1.33 12.033 10.713 10.713 0 0 1 12.033 1.33zm-.238 9.65a.68.68 0 1 0 0 1.36.68.68 0 0 0 0-1.36zm.38 3.377a.405.405 0 0 0-.17.038c-.402.16-1.205.908-2.02 1.51-.814.602-1.483.923-1.9 1.016a.748.748 0 1 0 .333 1.458c.693-.158 1.597-.595 2.527-1.26.742-.548 1.56-1.217 1.898-1.324a.748.748 0 0 0-.195-1.44z" />
    </svg>
  );
}

export function BurpSuiteIcon(props: ComponentProps<'svg'>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
      ...
      {...props}
    >
      <title>Burp Suite Icon</title>
      <path d="M 3.666 2 C 2.462 2 1.5 2.962 1.5 4.166 L 1.5 19.834 C 1.5 21.038 2.462 22 3.666 22 L 11.5 22 L 11.5 18.073 L 15.292 14.281 L 11.5 14.281 L 11.5 9.729 L 6.292 9.729 L 11.5 4.521 L 11.5 2 Z M 12.5 2 L 12.5 4.729 L 8.708 8.521 L 12.5 8.521 L 12.5 12.938 L 17.708 12.938 L 12.5 18.146 L 12.5 22 L 21 22 C 22.204 22 23.166 21.038 23.166 19.834 L 23.166 4.166 C 23.166 2.962 22.204 2 21 2 Z" />
    </svg>
  );
}
...
export function CybersecurityIcon(props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
    ...
    >
      ...
      <path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm0 2.25c4.914 0 8.91 3.996 8.91 8.91S16.914 19.07 12 19.07 3.09 15.074 3.09 10.16 7.086 2.25 12 2.25zM12 8.437a.562.562 0 1 0 0 1.125.562.562 0 0 0 0-1.125zm0 1.688a.563.563 0 1 0 0 1.125.563.563 0 0 0 0-1.125zm0 1.687a.563.563 0 1 0 0 1.125.563.563 0 0 0 0-1.125z" />
    </svg>
  );
}
...
export function LinkedInIcon(props) {
  return (
    ...
    >
      ...
      <path d="M21.705 0H2.295C1.029 0 0 1.029 0 2.295v19.41C0 22.971 1.029 24 2.295 24h19.41C22.971 24 24 22.971 24 21.705V2.295C24 1.029 22.971 0 21.705 0zM7.988 19.052H4.604V9.197h3.384v9.855zm-1.692-11.24a1.726 1.726 0 1 1-.001-3.451 1.726 1.726 0 0 1 .001 3.451zM20.057 19.052h-3.383v-5.263c0-1.257-.025-2.871-1.749-2.871-1.75 0-2.019 1.368-2.019 2.782v5.352h-3.384V9.197h3.275v1.478h.046c.457-.867 1.573-1.782 3.23-1.782 3.45 0 4.084 2.269 4.084 5.215v5.944z" />
    </svg>
  );
}

export function WazuhIcon(props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
      ...
      {...props}
    >
      <title>Wazuh Icon</title>
      <path d="M12 0L1.392 6v12L12 24l10.608-6V6L12 0zm0 1.2l9.6 5.4v10.8l-9.6 5.4-9.6-5.4V6.6L12 1.2zM10.8 6v12l-5.4-3.6V9.6L10.8 6zm2.4 0l5.4 3.6v5.4l-5.4 3.6V6zm-1.2 1.2L6 9.6v4.8l5.4 3.6v-12zm2.4 0v12L18 14.4V9.6L14.4 7.2z" />
    </svg>
  );
}

export function DevOpsIcon(props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
    ...
    >
      ...
      <path d="M17.25 2.25v5.325H6.75V2.25h10.5zM6.75 9.75H17.25V22.5H6.75V9.75zM2.25 17.25h5.325V22.5H2.25v-5.25zM16.5 16.5a.75.75 0 1 0 0-1.5.75.75 0 0 0 0 1.5zm-3.75 0a.75.75 0 1 0 0-1.5.75.75 0 0 0 0 1.5z" />
    </svg>
  );
}

export function CodersIcon(props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
      ...
      {...props}
    >
      <title>Coders Icon</title>
      <path d="M12 2.25L4.5 6.75v10.5L12 21.75l7.5-4.5v-10.5L12 2.25zM7.5 16.5V7.5l4.5-2.625L16.5 7.5v9l-4.5 2.625-4.5-2.625z" />
    </svg>
  );
}
