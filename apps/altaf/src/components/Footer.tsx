  ...
  return (
    <div className={clsx('max-w-[348px]')}>
      ...
      <p className={clsx('mb-4 font-normal leading-relaxed')}>
        I&apos;m Altaf, a <strong>Tech Lover</strong> who loves
        <strong> learning new things</strong> and <strong>sharing</strong>
      </p>
      <ul className={clsx('-ml-2 flex gap-1')}>
        <li>
          <a
            href="https://x.com/Dark_Mechanic"
            target="_blank"
            rel="noreferrer nofollow"
        ...
        <li>
          <a
            href="https://www.linkedin.com/in/altaf-pasha-36a822204/"
            target="_blank"
            rel="noreferrer nofollow"
            className={clsx('flex h-9 w-9 items-center justify-center')}
      ...
      <div className={clsx('content-wrapper')}>
        ...
        >
          <div className={clsx('font-semibold')}>
            &copy; {dayjs().format('YYYY')}, A L T A F
          </div>
